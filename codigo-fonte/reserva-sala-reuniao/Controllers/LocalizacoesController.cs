...
namespace reserva_sala_reuniao.Controllers
{
    public class LocalizacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao")] Localizacao localizacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Nome,Descricao")] Localizacao localizacao)
        {
        ...
        private bool LocalizacaoExists(long id)
        {
